...
public class DataBaseHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String CREATE_TABLE_SCIENCE = "CREATE TABLE \""+TABLE_SCIENCE+"\" (\""+Columns.KEY_SCIENCE_ID+"\" INTEGER PRIMARY KEY  AUTOINCREMENT  , \""+Columns.KEY_SCIENCE_TITLE+"\" TEXT, \""+Columns.KEY_SCIENCE_LINK+"\" TEXT)";
